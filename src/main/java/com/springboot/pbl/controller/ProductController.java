...
package com.springboot.pbl.controller;
...
import com.springboot.pbl.PblbackendApplication;
import com.springboot.pbl.config.UserInfoUserDetailsService;
import com.springboot.pbl.dto.AuthRequest;
import com.springboot.pbl.dto.AuthResponse;
import com.springboot.pbl.dto.Product;
import com.springboot.pbl.entity.UserInfo;
import com.springboot.pbl.repository.UserInfoRepository;
import com.springboot.pbl.service.JwtService;
import com.springboot.pbl.service.ProductService;
...
public class ProductController {
    ...
    public ResponseEntity<String> addNewUser(@RequestBody UserInfo userInfo) {
        String code = PblbackendApplication.codes.get(userInfo.getEmail());
        ...
        PblbackendApplication.codes.remove(userInfo.getEmail());
...
//    }
    ...
    public ResponseEntity<String> changePassword(@PathVariable("code") String code,@PathVariable("email") String email,@PathVariable("newpassword") String newpassword) {
        String sCode = PblbackendApplication.codes.get(email);
        ...
        PblbackendApplication.codes.remove(email);
